...
public class DictionaryServlet extends HttpServlet {
	...
	private static final Logger _logger = Logger
			.getLogger(DictionaryServlet.class);
	...
	private String getFromGuvnor(String uuid, IDiagramProfile profile) {
		...
		String dictionaryURL = packagesBase + "globalArea/assets/"
				+ DICTIONARY_FNAME;

		String dictionarySourceURL = packagesBase + "globalArea/assets/"
				+ DICTIONARY_FNAME + "/source/";
		try {
			...
			if (checkConnection.getResponseCode() == 200) {
				InputStream in = ServletUtil.getInputStreamForURL(
						dictionarySourceURL, "GET", profile);
	...
	private void storeToGuvnor(String uuid, IDiagramProfile profile,
		...
		String dictionaryURL = globalAreaAssets + DICTIONARY_FNAME;
		String dictionaryDeleteURL = globalAreaAssets + DICTIONARY_FNAME;

		String dictionaryAssetsURL = globalAreaAssets;
		try {
			...
			createConnection.setRequestProperty("Slug", DICTIONARY_FNAME
					+ DICTIONARY_FEXT);
