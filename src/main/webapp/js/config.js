...
ORYX.CONFIG.KOALA_CORE_BASE = "http://localhost:8080/Koala-Core/";

ORYX.CONFIG.PROCESS_IMAGE_URL = function(processId) {
	return ORYX.CONFIG.KOALA_CORE_BASE+"processImage?processId="+processId;
}

ORYX.CONFIG.ACTORS_BY_BUSINESS_FORM = true;
...
ORYX.CONFIG.CANVAS_HEIGHT =				1000;
...
ORYX.CONFIG.SHOW_GRIDLINE =             true;
ORYX.CONFIG.EXT_WINDOW_Y =         80;

ORYX.CONFIG.BORDER_OFFSET =				14;

ORYX.CONFIG.MAX_NUM_SHAPES_NO_GROUP	=	7/*14*/;
...
ORYX.CONFIG.STENCIL_GROUP_ORDER = function() {
	...
	var ns="http://b3mn.org/stencilset/bpmn2.0#";
	stencilsHash[ns] = {};
	
	stencilsHash[ns]["Start Events"] = 1;
	stencilsHash[ns]["Catching Intermediate Events"] = 2;
	stencilsHash[ns]["Throwing Intermediate Events"] = 3;
	stencilsHash[ns]["End Events"] = 4;
	stencilsHash[ns]["Gateways"] = 5;
	stencilsHash[ns]["Activities"] = 6;
	stencilsHash[ns]["Service Tasks"] = 7;
	stencilsHash[ns]["Connecting Objects"] = 8;
	stencilsHash[ns]["Data Objects"] = 9;
	stencilsHash[ns]["Swimlanes"] = 10;
	stencilsHash[ns]["Artifacts"] = 11;
	
	// jbpm minimal perspective
	
	stencilsHash[ns]["Task"] = 7;
	stencilsHash[ns]["Reusable Subprocess"] = 8;
	stencilsHash[ns]["Multiple instances"] = 9;
	stencilsHash[ns]["Embedded Subprocess"] = 10;
	stencilsHash[ns]["Data-based Exclusive (XOR) Gateway"] = 6;
	stencilsHash[ns]["Start Event"] = 1;
	stencilsHash[ns]["Timer Intermediate Event"] = 2;
	stencilsHash[ns]["Signal Intermediate Event"] = 3;
	stencilsHash[ns]["End Event"] = 4;
	stencilsHash[ns]["Error End Event"] = 5;
	stencilsHash[ns]["Sequence Flow"] = 11;
	return stencilsHash;
};
